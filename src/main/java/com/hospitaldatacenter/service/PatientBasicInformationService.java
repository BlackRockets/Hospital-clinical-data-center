...
public interface PatientBasicInformationService {
     ...
     * @return 对象列表
     */
    List<PatientBasicInformation> queryAllByLimit(int offset, int limit);
     ...
     * @return 实例对象
     */
    PatientBasicInformation insert(PatientBasicInformation patientBasicInformation);
     ...
     * @return 实例对象
     */
    PatientBasicInformation update(PatientBasicInformation patientBasicInformation);
